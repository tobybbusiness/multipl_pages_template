<template>
  <section class="blog">
    <div class="py-8 md:py-16 text-center">
      <h1 class="text-lg md:text-xl lg:text-4xl xl:text-6xl">Completed Projects</h1>
      <h2 class="text-base md:text-lg lg:text-xl xl:text-2xl">
        Below is a sample of some of our completed projects. Feel free to take inspiration from these and contact us for specific requirements.
      </h2>
    </div>
